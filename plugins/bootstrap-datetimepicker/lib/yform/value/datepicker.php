    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'attributes' => ['type' => 'choice',    'label' => 'Class', 'choices' => ['{"class":"datepicker"}' => 'datepicker', '{"class":"datetimepicker"}' =>  'datetimepicker' , '{"data-yform-tools-datetimepicker":"YYYY-MM-DD HH:ii"}' =>  'data-yform-tools-datetimepicker',  '{"data-yform-tools-datepicker":"YYYY-MM-DD"}' => 'data-yform-tools-datepicker' ], 'default' => 'select'],
                'notice' => ['type' => 'text',    'label' => rex_i18n::msg('yform_values_defaults_notice')],
              //  'prepend' => ['type' => 'text',    'label' => rex_i18n::msg('yform_values_defaults_prepend')],
             //  'append' => ['type' => 'text',    'label' => rex_i18n::msg('yform_values_defaults_append')],  // >> class="glyphicon glyphicon-calendar" ??
            ],
